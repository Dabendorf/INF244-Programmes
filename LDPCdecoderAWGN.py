...
def gallager(G: np.ndarray, H: np.ndarray, r: List[int], N0: float) -> List[int]:
...
# python LDPCdecoderAWGN.py systematic paritycheck sequence N0
# python LDPCdecoderAWGN.py G H r N0
# python LDPCdecoderAWGN.py G.csv H4.csv -0.2S0.3S-1.2S0.5S-0.8S-0.6S1.1 4
def main():
	...
	# Gallager decoding
	vhat__gallager = gallager(G, H, r, N0)
	print("vhat gallager")
	print(vhat__gallager)
	
	# MinSum decoding
	vhat_minsum = minSum(G, H, r, N0, debug_mode=False)
	print("vhat minsum")
	print(vhat_minsum)
